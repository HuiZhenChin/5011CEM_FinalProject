...
for state_file in state_files:
    ...
    data_df = pd.DataFrame({'Order Item ID': order_items_in_state['order_item_id'], 'Product ID': 
                            order_items_in_state['product_id']})
...
ax.legend(handles=legend_labels, title='Product Category', loc='upper right', bbox_to_anchor=(1.25, 1.0), borderaxespad=0.5, markerscale=2.0)
